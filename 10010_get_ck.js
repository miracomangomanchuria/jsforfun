...
!(async () => {
    if ($.env.isNode) {
        ...
        let marker2 = 'login_vcode_member.htm';
        console.log("===========url===============")
        console.log(url)
