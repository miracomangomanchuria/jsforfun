...
!(async () => {
    if ($.env.isNode) {
        ...
        console.log("===========url===============")
        console.log(url)
        console.log("===========waterTree位置===============")
        console.log(url.indexOf('waterTree?treeId='))
        console.log("===========meituan.com位置===============")
        console.log(url.indexOf('meituan.com'))

        if (((url.indexOf('waterTreeV2') > -1) && (url.indexOf('meituan.com') > -1)) && (url.indexOf('treeId=') > -1)) {
            let tk = '';
            console.log(headers)
            console.log("===========t位置===============")
            tk = headers['t']
